				...
				<div className='relative flex h-20 items-center justify-between'>
					...
					<div className='flex flex-1 items-center justify-center md:items-stretch md:justify-start'>
						...
						>
							...
							<h1 className='hidden md:block text-white text-2xl font-bold ml-2'>
								Jama<span className="bg-black px-2 py-1 rounded-md">Baba</span>
							</h1>
						</Link>
					...
					<div className='hidden md:block md:ml-6'>
						<div className='flex items-center'>
							<button className='flex items-center text-white bg-black hover:bg-gray-900 hover:text-white rounded-md px-3 py-2'>
